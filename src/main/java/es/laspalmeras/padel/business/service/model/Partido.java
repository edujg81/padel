...
public class Partido {
	...
	private Integer juegosGanadosEquipo1;
	private Integer juegosPerdidosEquipo1;
	private Integer setsGanadosEquipo1;
	private Integer setsPerdidosEquipo1;
	private Integer juegosGanadosEquipo2;
	private Integer juegosPerdidosEquipo2;
	private Integer setsGanadosEquipo2;
	private Integer setsPerdidosEquipo2;

	@ManyToMany
	@JoinTable(name = "partido_jugadores", joinColumns = @JoinColumn(name = "partido_id"), inverseJoinColumns = @JoinColumn(name = "jugador_id"))
