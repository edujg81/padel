...
public class PartidoMapperImpl implements PartidoMapper {
    ...
    public PartidoDTO toDto(Partido partido) {
        ...
        partidoDTO.setFechaCreacion( partido.getFechaCreacion() );
        partidoDTO.setFechaModificacion( partido.getFechaModificacion() );
    ...
    public Partido toEntity(PartidoDTO partidoDTO) {
        ...
        partido.setFechaCreacion( partidoDTO.getFechaCreacion() );
        partido.setFechaModificacion( partidoDTO.getFechaModificacion() );
